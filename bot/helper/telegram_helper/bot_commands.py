...
class _BotCommands:
    def __init__(self):
        self.StartCommand = getCommand('START_COMMAND', 'start2')
        ...
        self.CancelAllCommand = getCommand('CANCEL_ALL_COMMAND', 'cancelall2')
        self.ListCommand = getCommand('LIST_COMMAND', 'list2')
        ...
        self.PingCommand =  getCommand('PING_COMMAND','ping2')
        ...
        self.RssListCommand = getCommand('RSSLIST_COMMAND', 'rsslist2')
        self.RssGetCommand = getCommand('RSSGET_COMMAND', 'rssget2')
        self.RssSubCommand = getCommand('RSSSUB_COMMAND', 'rsssub2')
        self.RssUnSubCommand = getCommand('RSSUNSUB_COMMAND', 'rssunsub2')
        self.RssUnSubAllCommand = getCommand('RSSUNSUBALL_COMMAND', 'rssunsuball2')
        self.AddleechlogCommand = getCommand('ADDLEECHLOG_COMMAND', 'addll2')
        self.RmleechlogCommand = getCommand('RMLEECHLOG_COMMAND', 'rmll2')
        self.AddleechlogaltCommand = getCommand('ADDLEECHLOGALT_COMMAND', 'addleechlog2')
        self.RmleechlogaltCommand = getCommand('RMLEECHLOGALT_COMMAND', 'rmleechlog2')
